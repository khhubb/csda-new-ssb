// DalyPlanOrdersOnlySet.cpp : implementation file

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  Function   :  This program reads in orders (database field exchange) distinguishing 910s governed in part by Query Stlmake_Daily_Plan_Last_Download_Time,
//                which is very important in displaying order field data associated with 910s. This query tells us the difference 
//                between new and old 910s. Basically it looks at the last time mainframe data was input to the Stlmake_Daily_Plan
//                table.      
//	Maintenance:
//
...
/////////////////////////////////////////////////////////////////////////////
// CDalyPlanOrdersOnlySet

IMPLEMENT_DYNAMIC(CDalyPlanOrdersOnlySet, CRecordset)

CDalyPlanOrdersOnlySet::CDalyPlanOrdersOnlySet(CDatabase* pdb)
	: CRecordset(pdb)
{
	//{{AFX_FIELD_INIT(CDalyPlanOrdersOnlySet)
	m_MILL_ORDER_NO = 0;
	...
	m_MORD_PROV_CAST_SL_WTH_MAX = 0.0f;  // added these 2 fields via MFC Wizard for reprovide limits 11-11-03 k. hubbard
	m_MORD_PROV_CAST_SL_WTH_MIN = 0.0f;  //  used wizard update columns button linked to OrdersForDailyPlanOnly fields in newinl via ODBC path. k. hubbard
...
CString CDalyPlanOrdersOnlySet::GetDefaultConnect()
{
	return _T("ODBC;DSN=DPATest");
}

CString CDalyPlanOrdersOnlySet::GetDefaultSQL()
{
	return _T("[ordersfordailyplanonly]");
}

void CDalyPlanOrdersOnlySet::DoFieldExchange(CFieldExchange* pFX)
{
	//{{AFX_FIELD_MAP(CDalyPlanOrdersOnlySet)
	...
	RFX_Single(pFX, _T("[MORD_PROV_CAST_SL_WTH_MAX]"), m_MORD_PROV_CAST_SL_WTH_MAX);
...
/////////////////////////////////////////////////////////////////////////////
// CDalyPlanOrdersOnlySet diagnostics

#ifdef _DEBUG
void CDalyPlanOrdersOnlySet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CDalyPlanOrdersOnlySet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
