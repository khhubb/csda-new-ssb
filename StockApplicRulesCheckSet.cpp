// StockApplicRulesCheckSet.cpp : implementation file
//

#include "stdafx.h"
#include "csda.h"
#include "StockApplicRulesCheckSet.h"
...
/////////////////////////////////////////////////////////////////////////////
// StockApplicRulesCheckSet

IMPLEMENT_DYNAMIC(StockApplicRulesCheckSet, CRecordset)

StockApplicRulesCheckSet::StockApplicRulesCheckSet(CDatabase* pdb)
	: CRecordset(pdb)
{
	//{{AFX_FIELD_INIT(StockApplicRulesCheckSet)
	m_CASTER_UNIT = 0;
	m_HEAT_SPEC = _T("");
...
CString StockApplicRulesCheckSet::GetDefaultConnect()
{
	return _T("ODBC;DSN=rules");
}

CString StockApplicRulesCheckSet::GetDefaultSQL()
{
	return _T("[dbo].[CASTER_STRING_LENGTHS_OLD]");
}

void StockApplicRulesCheckSet::DoFieldExchange(CFieldExchange* pFX)
{
	//{{AFX_FIELD_MAP(StockApplicRulesCheckSet)
...
/////////////////////////////////////////////////////////////////////////////
// StockApplicRulesCheckSet diagnostics

#ifdef _DEBUG
void StockApplicRulesCheckSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void StockApplicRulesCheckSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
